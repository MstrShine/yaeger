...
/**
 * A {@link YaegerStage} encapsulates an JavaFX {@link Stage}. It defines the
 * window that is being used and contains the {@link SceneCollection} that
 * contains all instances of {@link YaegerScene} that are part of the
 * {@link YaegerGame}.
 */
public class YaegerStage implements Initializable {
	...
	/**
	 * Create a new {@code YaegerStage} with the given parameters. A
	 * {@code YaegerStage} encapsulates a {@link Stage}, which is the representation
	 * of the window. The {@link Scene}, which is encapsulated by the
	 * {@link YaegerScene} will then represent the content of the window.
	 *
	 * @param yaegerGame   the {@link YaegerGame} for which this
	 *                     {@code YaegerStage is created}
	 * @param stage        the {@link Stage} that should be encapsulated. This
	 *                     {@link Stage} is created by JavaFX whenever a JavaFX is
	 *                     created
	 * @param yaegerConfig the {@link YaegerConfig} that contains runtime
	 *                     configurations for this {@link YaegerGame}
	 */
	 ...
	 *
	 * @param size a {@link Size} object that encapsulates the {@code width} and
	 *             {@code height} of the game
	 */
	 ...
	 *
	 * @param id    the number as an {@code int} that identifies the
	 *              {@link YaegerScene}. By calling the method
	 *              {@link #setActiveScene(int)} the added {@link YaegerScene} can
	...
	/**
	 * Set the {@link SceneCollectionFactory} to be used whenever a
	 * {@link SceneCollection} has to be created.
	 *
	...
	/**
	 * Set the {@link SceneFactory} to be used whenever a {@link Scene} has to be
	 * created.
	 *
